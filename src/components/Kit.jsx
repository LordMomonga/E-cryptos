    ...
    return(
        <div className="kitcomplete">
            ...
            <div className="kit-container">
                ...
                <ul>
                    <li>si c'est votre toute première fois d'interagir  avec le terme BItCoin et block chain, un tutoriel plus complet vous est fournit <a href="https://cryptosexpo.com/courses/emergency-crypto/" className="bouton1"><em>cliquer la</em></a> </li>
                    <li>si vous avez deja eu a manipuler un wallet et vous voulez vous ameliorer encore plus <em><a href="https://cryptosexpo.com/courses/emergency-crypto/
"><span className="bouton1">cliquer la</span></a></em>  </li>
